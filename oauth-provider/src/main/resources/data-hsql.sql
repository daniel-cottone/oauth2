...
insert into clients(id,client_id,client_secret,resource_ids,scopes,grant_types,redirect_uris,auto_approve_scopes) values(clients_seq.nextval,'acme','acmesecret',null,'openid','authorization_code,implicit,password,refresh_token',null,null)
